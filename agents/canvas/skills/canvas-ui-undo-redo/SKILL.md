...
description:
  Analyze, debug, or modify Drupal Canvas UI undo/redo behavior across Redux
  slices. Use when work touches timeline history, redux-undo integration,
  historyEraser logic, uiSlice undoStack or redoStack, undo/redo middleware, or
  tests for cross-slice timeline consistency.
---
